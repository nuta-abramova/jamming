...
const Spotify = {
  //get user token if provided, if not, use an auth uri to generate access token
  getAccessToken() {
    if (accessToken) {
      return accessToken;
  ...
  savePlaylist(name, trackUris) {
    ...
    return fetch(endpointId, {
      ...
      //create the new playlist for the users
      ...
      //create new playlist in the user accounts
